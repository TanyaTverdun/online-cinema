...
namespace onlineCinema.Application.Interfaces
{
    public interface IBookingRepository : IGenericRepository<Booking>
    {
        ...
        Task<(IEnumerable<Booking> Items, int TotalCount, bool HasNext, bool HasPrevious)> GetUserBookingsSeekAsync(string userId, int? lastId, int? firstId, int pageSize);
    }
}